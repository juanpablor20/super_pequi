    ...
    <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{ route('register') }}" method="post" autocomplete="off" novalidate>
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="role" value="bibliotecario">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="type_identification"
                        class="form-control @error('type_identification') is-invalid @enderror"
                        placeholder="Enter Tipo de Documento">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sex_user" class="form-control @error('sex_user') is-invalid @enderror"
                        placeholder="Enter Tipo de sexo">
                    @error('sex_user')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="gender_sex"
                            class="form-control @error('gender_sex') is-invalid @enderror" placeholder="Enter genero">
                        @error('sex_user')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
