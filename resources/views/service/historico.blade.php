                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Buscar servicio" aria-label="Buscar servicio">
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-1">No. <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm text-dark icon-thick" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="6 15 12 9 18 15"/></svg></th>
                                        <th>Fecha</th>                                      
                                ...
                                <tbody>
                                    @forelse ($services as $service)
                                        <tr>
                                            ...
                                            <td>{{ $service->state_ser }}</td>
                                            <td>
                                                @foreach ($librarians as $librarian)
                                                    @if ($librarian->id === $service->librarian_id)
                                                        {{ $librarian->names }}
                                                        {{ $librarian->last_name }}
                                                    @endif
                                                @endforeach
