    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="names" value="{{ $user->names ?? '' }}"
                class="form-control @error('names') is-invalid @enderror" placeholder="Names">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="sex_user" value="{{ $user->sex_user ?? '' }}"
                class="form-control @error('sex_user') is-invalid @enderror" placeholder="Sex User">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="gender_sex" value="{{ $user->gender_sex ?? '' }}"
                class="form-control @error('gender_sex') is-invalid @enderror" placeholder="Gender Sex">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="email_con" value="{{ $user->contacts->email_con ?? '' }}"
                class="form-control @error('email_con') is-invalid @enderror" placeholder="Email">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="telephone_con" value="{{ $user->contacts->telephone_con ?? '' }}"
                class="form-control @error('telephone_con') is-invalid @enderror" placeholder="Telephone">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div>
            <input type="text" name="addres_add" value="{{ $user->address->addres_add ?? '' }}"
                class="form-control @error('addres_add') is-invalid @enderror" placeholder="Addres_add">
