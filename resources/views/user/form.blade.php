...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('names', $user->names, ['class' => 'form-control' .
        ($errors->has('names') ? ' is-invalid' : ''), 'placeholder' => 'Names']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        ($errors->has('last_name') ? ' is-invalid' : ''), 'placeholder' => 'Last Name']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('type_identification', $user->type_identification, ['class' => 'form-control' .
        ($errors->has('type_identification') ? ' is-invalid' : ''), 'placeholder' => 'Type Identification']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('number_identification', $user->number_identification, ['class' => 'form-control' .
        ($errors->has('number_identification') ? ' is-invalid' : ''), 'placeholder' => 'Number Identification']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('sex_user', $user->sex_user, ['class' => 'form-control' .
        ($errors->has('sex_user') ? ' is-invalid' : ''), 'placeholder' => 'Sex User']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('gender_sex', $user->gender_sex, ['class' => 'form-control' .
        ($errors->has('gender_sex') ? ' is-invalid' : ''), 'placeholder' => 'Gender Sex']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('email_con', $contact->email_con ?? '', ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('telephone_con', $user->contacts->telephone_con ?? '', ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('addres_add', $user->address->addres_add ?? '', ['class' => 'form-control' .
