                ...
                <div class="col col-login mx-auto">
                    ...
                    <form class="card" action="{{ route('password.email') }}" method="post" novalidate>
                        ...
                        <div class="card-body p-6">
                            ...
                            <p class="text-muted">@lang('Introduce tu dirección de correo electrónico.')</p>
                            ...
                            <div class="form-footer">
                                <button type="submit" class="btn btn-primary btn-block">@lang('Envíame mi nueva contraseña')</button>
                            </div>
                        </div>
                    </form>
